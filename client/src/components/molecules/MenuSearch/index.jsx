...
const MenuSearch = ({ logo, searchPlaceHolder, icon, sideToggle, setSideToggle, setProducts, inputValue, setInputValue, getResults, setLoading }) => {
    ...
    const handleEnter = (e,value) => {
        if(e.key === "Enter"){
            ...
            console.log('Error en key enter (handleEnter)')
        }
    }
