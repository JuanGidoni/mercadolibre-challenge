    ...
    <div className="d-flex flex-md-fill flex-row p-1 align-items-md-center justify-content-md-center">
      ...
      <div className="seachBar d-flex flex-fill">
        <Input
          ...
          className="w-100 ml-5 menu-meli-search"
          setInputValue={setInputValue}
          inputValue={inputValue}
          onKeyDown={(e) => handleEnter(e, inputValue)}
        />
        <div
          className="icon d-flex h-100 justify-content-center align-items-center p-3 bg-white cursor-pointer"
          onClick={() => searchProducts(inputValue)}
        >
          <img
            src={searchIcon}
            alt={searchPlaceHolder}
      ...
      <div className="d-flex align-items-md-center justify-content-md-center align-content-end">
        ...
        <Button
          ...
          className="d-block d-md-none btn align-content-end"
        >
